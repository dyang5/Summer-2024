...
\]
In general, for a given flag manifold $Fl(n_1, n_2, \dots, n)$, we find that the basis for the cohomology corresponds to a subset of the Schubert polynomials of $S_n$:
\[
    Fl(n_1, n_2, \dots, n) \leftrightarrow \{\mathfrak{S}_w \in S_n \mid w \text{ has descents } \subseteq \{ n_1, n_2, \dots, n\} \}
\]
