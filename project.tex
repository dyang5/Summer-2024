...
The \textbf{quantum cohomology ring} of a flag $F$ is denoted $QH^*(F)$ and it encodes information about the number of algebraic curves passing through multiple Schubert varieties.
\end{definition}
...
\textcolor{red}{Discuss partial flag case (CF), examples on board, use sigma matrices}
